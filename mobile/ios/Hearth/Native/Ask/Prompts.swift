...
/// One prompt template for copy-out context packs (prompts.ts, docs/design.md §6.3). The text is
/// English on every platform: it is written to the assistant, not shown to the user.
...
enum Prompts {
    static let all: [PromptTemplate] = [
        PromptTemplate(
            id: "explain", titleKey: "prompt.explain.title",
        ...
        PromptTemplate(
            id: "doctor", titleKey: "prompt.doctor.title",
        ...
        PromptTemplate(
            id: "medication", titleKey: "prompt.medication.title",
        ...
        PromptTemplate(
            id: "compare", titleKey: "prompt.compare.title",
        ...
        PromptTemplate(
            id: "labs", titleKey: "prompt.labs.title",
        ...
        PromptTemplate(
            id: "symptoms", titleKey: "prompt.symptoms.title",
        ...
        PromptTemplate(
            id: "second-opinion", titleKey: "prompt.second-opinion.title",
