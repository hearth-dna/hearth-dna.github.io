...
| `health-log` | one health-log entry | `person`, `date`, `time`, `kind`, `title`, `body_part`, `side`, `severity`, `value`, `value2`, `unit`, `analyte`, `ref_low`, `ref_high`, `flag`, `value_text`, `conditions`, `tags`, `source`, `body`, `created_at` |
